...
export const metadata: Metadata = {
  title: "Hire Mowlid Haibe — Get in touch",
  description:
    "Contact Mowlid Haibe (Malitos · Devmalitos) for web development, full-stack apps, and AI solutions. Based in Malaysia, working with clients worldwide.",
